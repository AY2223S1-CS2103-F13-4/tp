...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_UID = new Prefix("id/");
    ...
    public static final Prefix PREFIX_FULLY_ASSIGNED = new Prefix("as/");
    public static final Prefix PREFIX_FULLY_VISITED = new Prefix("v/");
