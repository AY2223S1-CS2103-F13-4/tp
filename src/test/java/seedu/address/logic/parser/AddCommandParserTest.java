...
import static seedu.address.logic.commands.CommandTestUtil.CATEGORY_DESC_NURSE;
import static seedu.address.logic.commands.CommandTestUtil.CATEGORY_DESC_PATIENT;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, CATEGORY_DESC_NURSE + CATEGORY_DESC_PATIENT + NAME_DESC_BOB
                + GENDER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple names - last name accepted
        assertParseSuccess(parser, CATEGORY_DESC_PATIENT + NAME_DESC_AMY + NAME_DESC_BOB
                + GENDER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple genders - last gender accepted
        assertParseSuccess(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB
        ...
        assertParseSuccess(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_PATIENT_CATEGORY + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing name prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + VALID_NAME_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + VALID_GENDER_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + VALID_PHONE_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing email prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
        ...
        assertParseFailure(parser, VALID_PATIENT_CATEGORY + VALID_NAME_BOB + VALID_GENDER_BOB + VALID_PHONE_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid category
        assertParseFailure(parser, INVALID_CATEGORY_DESC + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                "Category can only be P or N. P for patient, N for nurse.");

        // invalid name
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + INVALID_NAME_DESC + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Name.MESSAGE_CONSTRAINTS);

        // invalid gender
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + INVALID_GENDER_DESC + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Gender.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + INVALID_PHONE_DESC
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + DATETIME_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + DATETIME_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid datesTimes
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + INVALID_DATETIME_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, DateTime.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
                Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + INVALID_NAME_DESC + GENDER_DESC_BOB
                        + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + DATETIME_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB
